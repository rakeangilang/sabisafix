...
<div class=" sidebar" role="navigation">
    ...
    <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      <ul class="nav" id="side-menu">
        <li <?php if($active == 'dashboard'): ?> class="active" <?php endif; ?>><a href="#" ><i class="fa fa-home nav_icon"></i>Dashboard</a>
        </li>
        ...
        <li class="">
          ...
          <ul class="nav nav-second-level collapse">
            ...
            <li <?php if($active == 'post'): ?> class="active" <?php endif; ?>><a href="<?php echo e(route('post.pekerja')); ?>">Tambah Karyawan</a>
            </li>
          </ul>
        </li>
        ...
        <li>
          ...
          <ul class="nav nav-second-level collapse">
            ...
            <li <?php if($active == 'post'): ?> class="active" <?php endif; ?>><a href="<?php echo e(route('post.barang')); ?>">Tambah Barang</a>
            </li>
          </ul>
          <!-- //nav-second-level -->
        </li>
